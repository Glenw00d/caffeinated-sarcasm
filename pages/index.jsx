        ...
        {[ 
          {
            ...
            url: "https://www.redbubble.com/people/Sarkadib/shop?asc=u&ref=account-nav-dropdown"
          },
          {
            title: "TeePublic Store",
            desc: "Explore hilarious tees and more on TeePublic",
            url: "https://www.teepublic.com/user/caffeinated-sarcasm-co"
          },
          {
            title: "Amazon KDP",
          ...
          <div key={i} className="bg-white rounded-lg shadow p-6 flex flex-col items-center text-center">
            ...
            {item.comingSoon ? (
              <span className="text-[#a1887f] italic">Coming Soon</span>
            ) : (
              <a
                href={item.url}
                target="_blank"
